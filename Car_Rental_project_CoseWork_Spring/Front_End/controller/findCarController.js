          ...
          `<div class="col-4">
                ...
                <li>
                    <div class="featured-car-card">
                        <figure class="card-banner">
                            <img alt="Toyota RAV4 2021" class="w-100" height="300" loading="lazy"
                                  <img   src="http://localhost:8081/Back_End_war/uploads/${key.fontViewImage}"
                                 width="440">
                        </figure>
          ...
          `<div class="col-4">
                ...
                <li>
                    <div class="featured-car-card">
                        <figure class="card-banner">
                            <img alt="Toyota RAV4 2021" class="w-100" height="300" loading="lazy"
                                 src="http://localhost:8081/Back_End_war/uploads/${key.fontViewImage}"
                                 width="440">
                        </figure>
...
/*car Search by using different car properties  proceed implement  functions*/
...
function reserve(customer, bookingDenyOrAccept) {
  var AllDetails = [];
  for (var i = 0; i < $("#tblSelectedCars tbody tr").length; i++) {
    var driverWantOrNot = $('#checkDriverIfWant').is(':checked') ? "Want" : "Not Want";
  ...
  $.ajax({
    ...
    data: JSON.stringify(reserveDetail),
    success: function (response) {
      Swal.fire('Success', 'Successfully Reserved!', 'success');
      loadDriverSchedule();
